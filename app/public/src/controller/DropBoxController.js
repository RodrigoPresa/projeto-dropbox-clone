class DropBoxController {
    constructor(){
        ...
        this.newFolderBtn   = document.querySelector('#btn-new-folder');
        this.renameFileBtn  = document.querySelector('#btn-rename');
        this.deleteFileBtn  = document.querySelector('#btn-delete');
    ...
    //Método que prepara a conexão com o firebase
    connectFirebase(){
        var firebaseConfig = {
            apiKey: "AIzaSyCu2VnqxAKGdgP9ADQ2x_q5k0ol-Bl_zyU",
            authDomain: "dropbox-clone-db93e.firebaseapp.com",
            databaseURL: "https://dropbox-clone-db93e-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-db93e",
            storageBucket: "dropbox-clone-db93e.appspot.com",
            messagingSenderId: "273681454758",
            appId: "1:273681454758:web:b79894fe1f5364f3968667",
            measurementId: "G-NQQYZZNCMX"
        };
        // Initialize Firebase
    ...
    initEvents(){
        this.renameFileBtn.style.display = 'none';
        this.deleteFileBtn.style.display = 'none';

        this.renameFileBtn.addEventListener('click', e=>{
        ...
        //Evento criado para escutar quando há mudança na seleção dos arquivos da lista
        this.listFilesEl.addEventListener('selectionchange', e=>{
            ...
            switch(this.getSelection().length){
                case 0:
                    ...
                    break;
                case 1:
                    this.renameFileBtn.style.display = 'block';
                    this.deleteFileBtn.style.display = 'block';
                    break;
                default:
                    this.renameFileBtn.style.display = 'none';
                    this.deleteFileBtn.style.display = 'block';
    ...
    uploadTask(files){
        ...
        [...files].forEach(file=>{
            promises.push(new Promise((resolve, reject)=> {
                ...
                //responsável por calcular o tempo restante do upload do arquivo
    ...
    //Cria a referência para o firebase
    getFirebaseRef(){
    ...
    //Faz a leitura dos dados contidos no firebase e retorna na tela 
    readFiles(){
